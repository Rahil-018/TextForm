...
const About = () => {
    return (
        <>
            <div style={{ height: '100%', backgroundColor: '#353539', color: 'white' }}>
                ...
                <div className="m-3 row row-cols-1 row-cols-md-3 g-5 text-bg-white p-5" align="center" >
                    <div className="col g-1 ">
                        <div className="card">
                            <img src="\img\javascript.jpg" height={'200px'} width='50px' className="card-img-top" alt="..." />
                    ...
                    <div className="col g-1" >
                        <div className="card g-1">
                            <img src="\img.jpg\react.png" height={'225px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
                    ...
                    <div className="col g-1">
                        <div className="card g-1" >
                            <img src="\img\html.jpg" height={'200px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
                    ...
                    <div className="col g-1">
                        <div className="card g-1">
                            <img src="\img\css.png" height={'200px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
                    ...
                    <div className="col g-1">
                        <div className="card g-1">
                            <img src="\img\bootstrap.jpg" height={'200px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
                    ...
                    <div className="col g-1">
                        <div className="card g-1">
                            <img src="\img\jquery.png" height={'200px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
