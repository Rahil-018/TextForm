                ...
                <div className="m-3 row row-cols-1 row-cols-md-3 g-5 text-bg-white p-5" align="center" >
                    ...
                    <div className="col g-1" >
                        <div className="card g-1">
                            <img src="/img.jpg/react.jpg.png" height={'225px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
                    ...
                    <div className="col g-1">
                        <div className="card g-1" >
                            <img src="/img.jpg/html.jpg.jpg" height={'200px'} width={'100px'} className="card-img-top" alt="..." />
                            <div className="card-body">
